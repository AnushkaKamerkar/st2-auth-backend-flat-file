...
setup(
    ...
    version=version,
    description='Coditation authentication backend which reads credentials from a htpasswd compatible file on disk.',
    author='Coditation, Inc.',
    author_email='info@coditation.com',
    url='https://github.com/Coditation/st2-auth-backend-flat-file',
    license='Apache License (2.0)',
    download_url='https://github.com/Coditation/st2-auth-backend-flat-file/tarball/master',
    classifiers=[
